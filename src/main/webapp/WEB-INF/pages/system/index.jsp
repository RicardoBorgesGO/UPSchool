...
<head>
    ...
    <link rel="shortcut icon" href="resources/system/images/favicon.png">
    <title>BucketAdmin</title>
    <!--Core CSS -->
    <link href="resources/system/bs3/css/bootstrap.min.css" rel="stylesheet">
    <link href="resources/system/js/jquery-ui/jquery-ui-1.10.1.custom.min.css" rel="stylesheet">
    <link href="resources/system/css/bootstrap-reset.css" rel="stylesheet">
    <link href="resources/system/font-awesome/css/font-awesome.css" rel="stylesheet">
    <link href="resources/system/js/jvector-map/jquery-jvectormap-1.2.2.css" rel="stylesheet">
    <link href="resources/system/css/clndr.css" rel="stylesheet">
    <!--clock css-->
    <link href="resources/system/js/css3clock/css/style.css" rel="stylesheet">
    <!--Morris Chart CSS -->
    <link rel="stylesheet" href="resources/system/js/morris-chart/morris.css">
    <!-- Custom styles for this template -->
    <link href="resources/system/css/style.css" rel="stylesheet">
    <link href="resources/system/css/style-responsive.css" rel="stylesheet"/>
...
<div class="brand">
    ...
    <a href="index.html" class="logo">
        <img src="resources/system/images/logo.png" alt="">
    </a>
    ...
    <ul class="nav top-menu">
        ...
        <li id="header_inbox_bar" class="dropdown">
            ...
            <ul class="dropdown-menu extended inbox">
                ...
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="resources/system/images/avatar-mini.jpg"></span>
                                <span class="subject">
                ...
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="resources/system/images/avatar-mini-2.jpg"></span>
                                <span class="subject">
                ...
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="resources/system/images/avatar-mini-3.jpg"></span>
                                <span class="subject">
...
<div class="top-nav clearfix">
    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                <img alt="" src="resources/system/images/avatar1_small.jpg">
                    ...
                    <ul class="conversation-list">
                        <li class="clearfix">
                            <div class="chat-avatar">
                                <img src="resources/system/images/chat-user-thumb.png" alt="male">
                                <i>10:00</i>
                            </div>
                        ...
                        <li class="clearfix odd">
                            <div class="chat-avatar">
                                <img src="resources/system/images/chat-user-thumb-f.png" alt="female">
                                <i>10:00</i>
                            </div>
                            <div class="conversation-text">
                                <div class="ctext-wrap">
...
<div class="row">
    <div class="col-md-8">
        <section class="panel">
            <div class="wdgt-row">
                <img src="resources/system/images/weather_image.jpg" height="243" alt="">
                <div class="wdt-head">
                    weather forecast
                </div>
        ...
        <li>
            <div class="prog-row">
                <div class="user-thumb">
                    <a href="#"><img src="resources/system/images/avatar1_small.jpg" alt=""></a>
                </div>
            ...
            <div class="prog-row">
                <div class="user-thumb">
                    <a href="#"><img src="resources/system/images/avatar1.jpg" alt=""></a>
                </div>
                <div class="user-details">
            ...
            <div class="prog-row">
                <div class="user-thumb">
                    <a href="#"><img src="resources/system/images/chat-avatar2.jpg" alt=""></a>
                </div>
                <div class="user-details">
...
<!--Core js-->
<script src="resources/system/js/jquery.js"></script>
<script src="resources/system/js/jquery-ui/jquery-ui-1.10.1.custom.min.js"></script>
<script src="resources/system/bs3/js/bootstrap.min.js"></script>
<script src="resources/system/js/jquery.dcjqaccordion.2.7.js"></script>
<script src="resources/system/js/jquery.scrollTo.min.js"></script>
<script src="resources/system/js/jQuery-slimScroll-1.3.0/jquery.slimscroll.js"></script>
<script src="resources/system/js/jquery.nicescroll.js"></script>
<!--[if lte IE 8]><script language="javascript" type="text/javascript" src="js/flot-chart/excanvas.min.js"></script><![endif]-->
<script src="resources/system/js/skycons/skycons.js"></script>
<script src="resources/system/js/jquery.scrollTo/jquery.scrollTo.js"></script>
<script src="//cdnjs.cloudflare.com/ajax/libs/jquery-easing/1.3/jquery.easing.min.js"></script>
<script src="resources/system/js/calendar/clndr.js"></script>
<script src="http://cdnjs.cloudflare.com/ajax/libs/underscore.js/1.5.2/underscore-min.js"></script>
<script src="resources/system/js/calendar/moment-2.2.1.js"></script>
<script src="resources/system/js/evnt.calendar.init.js"></script>
<script src="resources/system/js/jvector-map/jquery-jvectormap-1.2.2.min.js"></script>
<script src="resources/system/js/jvector-map/jquery-jvectormap-us-lcc-en.js"></script>
<script src="resources/system/js/gauge/gauge.js"></script>
<!--clock init-->
<script src="resources/system/js/css3clock/js/css3clock.js"></script>
<!--Easy Pie Chart-->
<script src="resources/system/js/easypiechart/jquery.easypiechart.js"></script>
<!--Sparkline Chart-->
<script src="resources/system/js/sparkline/jquery.sparkline.js"></script>
<!--Morris Chart-->
<script src="resources/system/js/morris-chart/morris.js"></script>
<script src="resources/system/js/morris-chart/raphael-min.js"></script>
<!--jQuery Flot Chart-->
<script src="resources/system/js/flot-chart/jquery.flot.js"></script>
<script src="resources/system/js/flot-chart/jquery.flot.tooltip.min.js"></script>
<script src="resources/system/js/flot-chart/jquery.flot.resize.js"></script>
<script src="resources/system/js/flot-chart/jquery.flot.pie.resize.js"></script>
<script src="resources/system/js/flot-chart/jquery.flot.animator.min.js"></script>
<script src="resources/system/js/flot-chart/jquery.flot.growraf.js"></script>
<script src="resources/system/js/dashboard.js"></script>
<script src="resources/system/js/jquery.customSelect.min.js" ></script>
<!--common script init for all pages-->
<script src="resources/system/js/scripts.js"></script>
